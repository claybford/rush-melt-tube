...
function updatePreview() {
  ...
  function saveOptions(e) {
    ...
    // Validate colors
    const colorInputs = ['textColor', 'backgroundColor', 'buttonColor', 'buttonTextColor'];
  ...
  function restoreOptions() {
    ...
    browser.storage.local.get(defaultSettings)
      .then((settings) => {
        ...
        // Update all previews
        updateFontPreview();
        ['textColor', 'backgroundColor', 'buttonColor', 'buttonTextColor'].forEach(id => {
